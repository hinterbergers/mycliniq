...
const SCHOOL_HOLIDAYS: Record<string, CountryHolidayMap> = {
  AT: {
    ...
    ALL: {
      2025: [
        ...AT_COMMON_2025,
        AT_SEMESTER_2025_BURGENLAND_GROUP,
        AT_SUMMER_2025_WEST,
      ],
      2026: [
        ...AT_COMMON_2026,
        AT_SEMESTER_2026_BURGENLAND_GROUP,
        AT_SUMMER_2026_WEST,
      ],
    },
    "AT-1": {
    ...
    "AT-4": {
      2025: [
        ...AT_COMMON_2025,
        AT_SEMESTER_2025_OOE_STEIERMARK,
        AT_SUMMER_2025_WEST,
      ],
      2026: [
        ...AT_COMMON_2026,
        AT_SEMESTER_2026_OOE_STEIERMARK,
        AT_SUMMER_2026_WEST,
      ],
    },
    "AT-5": {
